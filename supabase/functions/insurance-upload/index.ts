...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Uploading insurance policy:', { employeeId, insurerName, productName, filename })
    ...
    const filePath = `insurance/${employee.emp_code}/${insurerName}/${filename}`
    ...
    console.log('Insurance policy uploaded to S3:', filePath)
